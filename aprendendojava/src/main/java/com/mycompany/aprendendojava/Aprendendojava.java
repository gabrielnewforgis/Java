...
public class Aprendendojava {
    ...
    public static void cadastrar(String[] nomes, int[] cpf, int[] celular, float[] saldo, int i) {
        int op=0;
        int op2=0;
        if (i >= nomes.length) {
        ...
        cpf[i] = n.nextInt();
        if (String.valueOf(cpf[i]).length() != 11) {
       ...
       while(op2 != 2){
        ...
        celular[i] = n.nextInt();
          if(String.valueOf(celular[i]).length() != 9){
         System.out.println("Numero de celular incorreto, informe um válido");
          }else{
              op2=2;
          }
          System.out.println("Nome: " + nomes[i] + "\nCPF: " + cpf[i] + "\nCelular: " + celular[i] + "\nSaldo: " + saldo[i]);
        System.out.println("O seu número de segurança é: " + i);
    }         
    }   
    ...
    public static int atualizar_cel(int[] celular) {
        int i;
        System.out.println("Insira o número de segurança do usuário");
        i = n.nextInt();
    ...
    public static void buscar_user(String[] nomes, int[] cpf, int[] celular) {
        ...
        while (op != 7) {
            ...
            switch (op) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    celular[i] = atualizar_cel(celular);
                    break;
                case 5:
                    buscar_user(nomes, cpf, celular);
                    break;
                case 6:
                    buscar_saldo(saldo);
            }
